...
public class JsonTaskGetFloorList extends AsyncTask<String, String, List<Floor>> {

    public JsonTaskGetFloorList() {
        super();
    }
...
//            connection.setRequestProperty("Authorization", "Bearer " + params[1]);
            ...
            if(authOk){
                ...
                Type t = new TypeToken<List<Floor>>(){}.getType();
    ...
    @Override
    protected void onPostExecute(List<Floor> result) {
